...
class PyppeteerRequest(Request):
    ...
    def __init__(self, url, callback=None, wait_until=None, wait_for=None, script=None, proxy=None,
        ...
        :param pdf_path: the path that download pdf by pyppeteer
        :param args:
        :param kwargs:
        """
        ...
        self.pdf_path = pyppeteer_mata.get('pdf_path') if pyppeteer_mata.get('pdf_path') is not None else pdf_path
        ...
        pyppeteer_mata['pdf_path'] = self.pdf_path
